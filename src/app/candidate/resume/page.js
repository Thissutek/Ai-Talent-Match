...
import { FiUpload, FiFile, FiCheckCircle, FiAlertCircle, FiArrowLeft, FiLogOut, FiDownload, FiTrash2 } from 'react-icons/fi';
...
export default function CandidateResumePage() {
  ...
  const handleDeleteResume = async () => {
    if (!confirm('Are you sure you want to delete your resume? This will remove all parsed skills and data.')) {
      return;
    }
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 sm:px-0">
          <h1 className="text-2xl font-semibold text-gray-900">Resume Management</h1>
        ...
        <div className="mt-6 px-4 sm:px-0">
              ...
              {profile?.resume_url ? (
                <div>
                  ...
                  <div className="mt-8 border-t border-gray-200 pt-6">
                    <h3 className="text-base font-medium text-gray-900 mb-4">Upload a new version</h3>
          ...
          {resumeData && (
            <div className="mt-6 bg-white rounded-lg shadow-md overflow-hidden">
              <div className="px-6 py-5 bg-gray-50 border-b border-gray-200">
                <h2 className="text-lg font-medium text-gray-900">Parsed Resume Data</h2>
              </div>
              ...
              <div className="px-6 py-5">
                  ...
                  <div className="bg-gray-50 p-4 rounded-md">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-sm font-medium">{resumeData.contactInfo?.name || 'Not found'}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">Email</p>
                        <p className="text-sm font-medium">{resumeData.contactInfo?.email || 'Not found'}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">Phone</p>
                        <p className="text-sm font-medium">{resumeData.contactInfo?.phone || 'Not found'}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* Skills */}
                <div className="mb-6">
                  <h3 className="text-sm font-medium text-gray-900 mb-3">Extracted Skills</h3>
                  <div className="bg-gray-50 p-4 rounded-md">
                    {resumeData.skills && resumeData.skills.length > 0 ? (
                      ...
                      <p className="text-sm text-gray-600">No skills extracted</p>
                    )}
                  </div>
                </div>
                ...
                {/* Work Experience */}
                <div className="mb-6">
                  <h3 className="text-sm font-medium text-gray-900 mb-3">Work Experience</h3>
                  <div className="bg-gray-50 p-4 rounded-md">
                    {resumeData.workExperience && resumeData.workExperience.length > 0 ? (
                      ...
                      <p className="text-sm text-gray-600">No work experience extracted</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-md">
                    {resumeData.education && resumeData.education.length > 0 ? (
                      ...
                      <p className="text-sm text-gray-600">No education history extracted</p>
                    )}
                  </div>
                </div>
              </div>

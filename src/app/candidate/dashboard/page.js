        ...
        !profile.interview_completed_at && (
          <div className="mt-6 bg-white rounded-lg shadow-md p-6">
            ...
            <Link
              ...
              className="inline-flex items-center px-4 py-2 border rounded-md shadow-sm text-sm font-medium text-white primary-button primary-button:hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >

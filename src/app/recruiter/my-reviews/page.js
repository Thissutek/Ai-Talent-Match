  ...
  return (
    <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      <div className="px-4 sm:px-0">
        <h1 className="text-2xl font-semibold primary">My Reviews</h1>
                ...
                <li key={review.id}>
                  ...
                  >
                    <div className="px-6 py-4">
                        ...
                        <div className="flex flex-col items-center">
                          <div
                            className={`w-10 h-10 rounded-full flex items-center justify-center text-white text-xs font-semibold ${
                              review.candidate_profiles.ai_ranking >= 8
                                ? "bg-green-500"
                                : review.candidate_profiles.ai_ranking >= 6
                                  ? "bg-blue-500"
                                  : review.candidate_profiles.ai_ranking >= 4
                                    ? "bg-yellow-500"
                                    : "bg-red-500"
                            }`}
                          >
                      ...
                      {/* Skills */}
                      {review.candidate_profiles.skills &&
                        review.candidate_profiles.skills.length > 0 && (

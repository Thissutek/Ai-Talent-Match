              ...
              <div className="space-y-3">
                <div className="relative flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-gray-500">Receive email notifications about new candidate matches and updates</p>
                  </div>
                </div>
                ...
                <div className="relative flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="notification_app" className="font-medium text-gray-700">

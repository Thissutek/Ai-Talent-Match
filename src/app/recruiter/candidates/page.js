    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 sm:px-0">
          <h1 className="text-2xl font-semibold primary">All Candidates</h1>
        ...
        <div className="mt-6 px-4 sm:px-0 flex flex-col md:flex-row gap-6">
          ...
          {/* Filters sidebar */}
          <div
            className={`bg-white/10 rounded-lg shadow-md p-4 w-full md:w-64 ${showFilters ? "block" : "hidden md:block"}`}
          >
            ...
            <div className="mb-4">
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  className="block w-full pl-10 py-2 border text-white border-gray-300 rounded-md text-sm focus:ring-blue-500 focus:border-blue-500"
            ...
            <button
              ...
              className="w-full py-2 text-sm primary hover:text-blue-800"
            >
              Reset all filters
            </button>
          </div>
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                ...
                {filteredCandidates.map((candidate) => (
                  <div
                    key={candidate.id}
                    className="bg-white/10 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 overflow-hidden"
                  >
                    <div className="px-6 py-4">
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex flex-col items-center">
                          <div
                            className={`w-12 h-12 rounded-full flex items-center justify-center text-white font-bold ${getRankingColor(
                    ...
                    {/* View profile button */}
                    <div className="px-6 py-3 bg-white/10 border-t ">
                      <Link
                        href={`/recruiter/candidates/${candidate.id}`}
                        className="flex items-center justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium primary-button primary-button:hover border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00ff9d] w-full"
                      >
                        View Profile

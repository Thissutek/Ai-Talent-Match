      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-gray-500 text-sm">Reviewed by You</p>
              <p className="text-2xl font-semibold">{stats.reviewedCandidates}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-gray-500 text-sm">High-Ranked Candidates</p>
              <p className="text-2xl font-semibold">{stats.highRankedCandidates}</p>
            </div>
          </div>
        </div>
      </div>

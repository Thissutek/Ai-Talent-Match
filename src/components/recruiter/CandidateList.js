...
export default function CandidateList() {
    ...
    try {
      ...
      if (filters.minRanking > 0) {
        filteredData = filteredData.filter(candidate => 
          candidate.ai_ranking >= filters.minRanking
        );
      }
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      <h2 className="text-2xl font-bold mb-6">Candidate Search</h2>
      ...
      <div className="mb-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => handleFilterChange({ ...filters, minRanking: parseFloat(e.target.value) })}
        ...
        <div>
          <div className="flex items-center mb-1">
            <FiFilter className="mr-2 text-gray-500" size={16} />
      ...
      <div className="space-y-4">
          ...
          candidates.map((candidate) => (
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="font-semibold text-lg">{candidate.full_name || 'Unknown Name'}</h3>
                  <p className="text-gray-600 text-sm">{candidate.users?.email || 'Email not available'}</p>
        ...
        {loading && (
          <div className="text-center py-4">
            <FiLoader className="animate-spin mx-auto mb-2 text-blue-500" size={24} />
